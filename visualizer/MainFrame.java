...
public class MainFrame extends JFrame {
    ...
    static {
        ...
        algorithmDisplayLabel.setFont(new Font("Arial", Font.BOLD, 25)); // 👈 Add this line
    ...
    private void setJMenu() {
        ...
        JCheckBoxMenuItem aiMode = new JCheckBoxMenuItem("Enable AI Optimization");
        algorithmsMenu.add(aiMode);
        aiMode.addActionListener(e -> Graph.setAIEnabled(aiMode.isSelected()));
    ...
    private void setModeJLabel() {
        ...
        modeLabel.setForeground(Vertex.DEFAULT_COLOR);
